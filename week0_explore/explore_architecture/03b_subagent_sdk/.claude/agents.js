// Agent definitions using Claude Agent SDK
// This replaces the filesystem-based agent loading with programmatic AgentDefinition
...
module.exports = {
  mudClientAgent: {
    ...
    instructions: `You are an autonomous agent controlling a character in tbaMUD (a CircleMUD variant). Your role is to explore the game world, complete objectives, manage character progression, and maintain detailed records of discoveries.
